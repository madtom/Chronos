//
//  CNX_LeistungenTableViewController.m
//  Chronos
//
...
@interface CNX_LeistungenTableViewController ()

@end

@implementation CNX_LeistungenTableViewController
...
-(NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Leistung" inManagedObjectContext:appDelegate.managedObjectContext];
